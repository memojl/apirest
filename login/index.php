<?php
include_once '../api/v1/includes/conexion.php';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <!-- Estilos -->
    <link rel="stylesheet" href="<?php echo $page_url;?>login/css/style.css">
...
<body>
   ...
   <!-- Formularios -->
    ...
    <?php echo $jQuery10;?>
   <script src="<?php echo $page_url;?>login/js/script.js"></script>
